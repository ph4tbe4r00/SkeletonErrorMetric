function [out] = threshold_data_loader(slices)


% threshold for which tesselation to use,
% NOT the threshold for the weights
TESS_THRESH_VAL = 170;
n = slices;
...
for i = 1:n
    fprintf('%u of %u...\n', i, n);
    [tessi{i} labi{i} ragi{i} softi{i} weightsi{i}] = do_things(i, TESS_THRESH_VAL, PATH);
    if i > 1
